<template>
  <div class="w-[100%] main">
    <h2
      class="w-[50%] max-xl:w-[100%] text-white text-4xl max-md:text-2xl pt-[100px] max-md:pt-[60px]"
    >
      Курсда таълим олишингиз шарт! <span class="md:block">агар ...</span>
    </h2>
    <div
    ...
    >
      ...
      >
        <img
          src="../assets/imgs/main-card3.png"
          alt="icon"
          class="absolute md:left-[-14px] md:top-[-82px] w-[137px] h-[137px] max-md:w-[109px] max-md:top-[-36px] max-md:left-0"
        />
        <p>

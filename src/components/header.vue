...
.header_content-left button {
    ...
    border: 1.5px solid rgb(21, 210, 232);
    border-radius: 7px;
    backdrop-filter: blur(22px);
    background: rgb(16, 166, 185);
...
@media (max-width: 768px) {
    ...
    .header_content-left button {
        background:
            linear-gradient(0deg, #15D2E8, #15D2E8);
        border: 1.5px solid #15D2E8;
        font-size: 16px;
        width: 100%;
        margin-top: 20px;
